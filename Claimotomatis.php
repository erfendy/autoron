<?php
date_default_timezone_set('Asia/Perth');
...
echo "\e[92m| ___\e[93mINSTAGRAM\e[92m_:\e[93m@erffendhy\e[92m__________________|\n";
...
// function change(){
        ...
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"G-WS3F24J"}');
